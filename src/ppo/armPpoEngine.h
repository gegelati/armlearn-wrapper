...
#ifndef ARM_PPO_ENGINE_H
#define ARM_PPO_ENGINE_H
...
class ArmPPOEngine{
    ...
    public:
        ArmPPOEngine(PPOParameters& ppoParams, ArmLearnWrapper* armLearnEnv, std::ostream& file, TrainingParameters& trainingParams,
        uint16_t maxNbActions, bool doValidation=false)
        : ppoParams(ppoParams), file(file), armLearnEnv(armLearnEnv), trainingParams(trainingParams),
        learningAgent(ppoParams, (trainingParams.actionSpeed) ? 17: 13, (ppoParams.multipleActions) ? 4:1) {
