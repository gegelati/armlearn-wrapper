...
for indexConf in range(nbconfig):
    ...
    shutil.copy(pathRootParams + "repoConfig/sacParams_" + str(indexConf) + ".json", pathParams + "sacParams.json")
    ...
    for indexSeed in range(nbSeed):
        ...
        # Run the training
        subprocess.run("./armSoftActorCritic {} {}params/ {} {}".format(indexSeed, pathConf, pathModel, pathSeed), shell=True)